...
public abstract class Marshalling
{
    ...
    extends StreamWriterDelegate
  {
    ...
    private class PendingElement
    {
      ...
      public PendingElement( final String localName )
      {
      ...
      extends PendingElement
    {
      ...
      public PendingElement2( final String namespaceURI, final String localName )
      {
        super( localName );
      ...
      extends PendingElement2
    {
      ...
      public PendingElement3( final String prefix, final String localName, final String namespaceURI )
      {
